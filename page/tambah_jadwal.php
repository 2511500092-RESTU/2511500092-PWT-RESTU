                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kelas" class="form-control" required>
                            ...
                            <?php
                            $kelas_q = mysqli_query($koneksi, "SELECT * FROM tabel_kelas");
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-2">
                                <select name="kd_mapel[]" class="form-control" required>
                                    ...
                                    <?php
                                    $mapel = mysqli_query($koneksi, "SELECT * FROM tabel_mapel");
                            ...
                            <div class="col-md-2">
                                <select name="kd_guru[]" class="form-control" required>
                                    ...
                                    <?php
                                    $guru = mysqli_query($koneksi, "SELECT * FROM tabel_guru");
